...
def ensemble_retriever_from_mods(mods, embeddings=None):
    ...
    # vs = create_low_dimension_vector_db(embeddings=embeddings, reduced_dim=1536)
    ...
    full_text_retriever = joblib.load('model/full_text_retriever.pkl')
    # joblib.dump(full_text_retriever, 'model/full_text_retriever.pkl')
